...
- Generated at: `2026-06-02T21:45:37.781941+00:00`
- Eval questions: `16`
- Result rows: `64`
...
|---|---:|---:|---:|---:|
| deterministic_controller | 0.0 | 0.543 | 6 | 19.4 |
| coverage_rag | 0.0 | 0.542 | 6 | 16.3 |
| plan_execute | 0.0 | 0.518 | 2 | 21.6 |
| react_loop | 0.0 | 0.542 | 6 | 16.6 |

## Category Coverage

| Category | Pass rate | Avg score | Rows |
|---|---:|---:|---:|
| hong_kong_university_commercialization | 0.0 | 0.76 | 8 |
| comparison | 0.0 | 0.607 | 4 |
| official_source_audit | 0.0 | 0.657 | 4 |
| startup_examples | 0.0 | 0.753 | 4 |
| shenzhen_policy | 0.0 | 0.44 | 12 |
| cross_border_comparison | 0.0 | 0.448 | 4 |
| gap_analysis | 0.0 | 0.4 | 4 |
| source_quality | 0.0 | 0.381 | 4 |
| current_web_needed | 0.0 | 0.644 | 8 |
| external_current | 0.0 | 0.509 | 4 |
| unanswerable | 0.0 | 0.348 | 8 |
...
- `coverage_rag` failed `latest_hong_kong_grants_requires_web`: What are the latest active Hong Kong startup grants or funding programmes a founder should verify today?
...
- `react_loop` failed `latest_hong_kong_grants_requires_web`: What are the latest active Hong Kong startup grants or funding programmes a founder should verify today?
